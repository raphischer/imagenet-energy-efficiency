...
do
python evaluate.py --backend $2 --data-path /raid/imagenet_$2 --output-dir $1 --eval-model $model
done
...
python evaluate.py --backend $2 --data-path /raid/imagenet_$2 --output-dir $1 --eval-model MobileNetV2
python evaluate.py --backend $2 --data-path /raid/imagenet_$2 --output-dir $1 --eval-model MobileNetV3Small
python evaluate.py --backend $2 --data-path /raid/imagenet_$2 --output-dir $1 --eval-model MobileNetV3Large
